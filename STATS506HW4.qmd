...
proc reg data=recs2020_weighted;
...
![](images/Screenshot 2023-10-23 at 11.16.53 PM.png){width="419"}
...
* Recode numeric values into binary (0 for same/better off, 1 for worse off)
gen WorseOff = (b3_numeric <= 2)  // 1 for "worse off", 0 for "same/better off"
```

![](images/Screenshot 2023-10-23 at 11.17.26 PM.png){width="436"}
...
![](images/Screenshot 2023-10-23 at 11.19.08 PM.png)

![](images/Screenshot 2023-10-23 at 11.19.23 PM.png)
